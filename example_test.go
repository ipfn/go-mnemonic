...
func ExampleNewMnemonic() {
	...
	// generate a mnemomic
	mnemomic, _ := mnemonic.New(entropy)
...
func ExampleNewSeed() {
	seed := mnemonic.NewSeed("all hour make first leader extend hole alien behind guard gospel lava path output census museum junior mass reopen famous sing advance salt reform", "TREZOR")
